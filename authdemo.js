...
app.get('/', (request, response) => {
  response.send(request.oidc.isAuthenticated() ? 'Logged in' : 'Logged out') // oidc = openidconnect
});
...
app.get('/user/by-uid', requiresAuth(), (request, response) => { // requiresAuth() is a middleware function. when handling this path, before we start to execute block of code below, call this function
